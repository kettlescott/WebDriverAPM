package automation.web.base.elements.factory.api;
...
import automation.web.base.elements.factory.internal.ElementDecorator;
...
public class ElementFactory {
    ...
    public static  <T> T initElements (WebDriver driver, Class<T> pageClassToProxy, Class [] types, Object [] objects){
        T page = instantiatePage(driver, pageClassToProxy,types, objects);
        return initElements(driver, page);
    }
    ...
    private static <T> T instantiatePage(WebDriver driver, Class<T> pageClassToProxy, Class [] types, Object [] objs) {
        try {
            try {
